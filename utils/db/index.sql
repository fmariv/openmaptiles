...
CREATE INDEX IF NOT EXISTS idx_aerodrome_label_geom ON icgc_data.aerodrome_label USING gist (ST_MakeValid(geom));
CREATE INDEX IF NOT EXISTS idx_aeroway_geom ON icgc_data.aeroway USING gist (ST_MakeValid(geom));
CREATE INDEX IF NOT EXISTS idx_ascensors_geom ON icgc_data.ascensors USING gist (ST_MakeValid(geom));
CREATE INDEX IF NOT EXISTS idx_boundary_geom ON icgc_data.boundary USING gist (ST_MakeValid(geom));
CREATE INDEX IF NOT EXISTS idx_building_geom ON icgc_data.building USING gist (ST_MakeValid(geom));
CREATE INDEX IF NOT EXISTS idx_building_bt5m_geom ON icgc_data.building_bt5m USING gist (ST_MakeValid(geom));
CREATE INDEX IF NOT EXISTS idx_building_z12_geom ON icgc_data.building_z12 USING gist (ST_MakeValid(geom));
CREATE INDEX IF NOT EXISTS idx_contour_geom ON icgc_data.contour USING gist (ST_MakeValid(geom));
CREATE INDEX IF NOT EXISTS idx_corbes_mtc250m_geom ON icgc_data.corbes_mtc250m USING gist (ST_MakeValid(geometry));
